...
/**
 * This code is from
 * <a href="http://java.sun.com/docs/books/tutorial/index.html">Java
 * Tutorial</a> The source is at
 * http://java.sun.com/docs/books/tutorial/uiswing/layout/example-1dot4/
 * SpringUtilities.java. No copyright or license information was in the source
 * file and it was from the tutorial. Thus assuming I could use it in this
 * program. Below is the original file header. The file is not modified other
 * than reformating white spaces.
 * <p>
 ...
 * </p>
 * TODO: Although algorithm wise is correct, this class fails to address the
 * problem of rounding errors. As the result, sometimes the last row can be
 * mismatched with other rows. The solution to the problem is to force the
 * alignment of edges.
 *
